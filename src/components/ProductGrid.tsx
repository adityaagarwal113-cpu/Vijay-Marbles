      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16">
          <div className="max-w-xl">
            ...
            <h2 className="font-serif text-3xl md:text-5xl font-medium text-brand-text tracking-tight leading-tight">
              Curated Showroom Grid
            </h2>
            <p className="text-brand-text-sec text-xs md:text-sm mt-3 font-light font-sans max-w-sm">
              Discover absolute fluid design, luxury surfaces, and mechanical perfection. Fit your sanctuary today.
            </p>
          </div>

          {/* Luxury Categories Navigation Filter Tabs */}
